...
function initROP()
{
	try
	{
		...
		if((!base_found)&&(!stackframe_found)&&(!j2_found)&&(!j1_found))
		{
			...
			//base_offsets.push(base_fp_addr);
		}
		showFoundOffsets(offset_find_base_fp);
		//if(base_verified){base_fp_addr=base_offsets[0];}
		...
		if((base_found)&&(!stackframe_found)&&(!j2_found)&&(!j1_found))
		{
			...
			//stack_offsets.push(stack_frame_addr);
		}
		showFoundOffsets(offset_find_stack_frame);
		//if(stackframe_verified){stack_frame_addr=stack_offsets[0];}
		// ==============================================================================
		...
		if((base_found)&&(stackframe_found)&&(!j2_found)&&(!j1_found))
		{
			...
			//jump2_offsets.push(jump_2_addr);
		}
		showFoundOffsets(offset_find_jump2);
		//if(j2_verified){jump_2_addr=jump2_offsets[0];}
		// ==============================================================================
		...
		if((base_found)&&(stackframe_found)&&(j2_found)&&(!j1_found))
		{
			...
			//jump1_offsets.push(jump_1_addr);
		}
		showFoundOffsets(offset_find_jump1);
		//if(j1_verified){jump_1_addr=jump1_offsets[0];}
		// ==============================================================================
