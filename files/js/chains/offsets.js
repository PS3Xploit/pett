				...
				case fwCompat[23]:
				   //alert(compat_msg_success);
					...
					if (confirm(msg_select_vsh_type)) {
						...
						g_set_r5_from_r31=0x1BD764;// verify this
						g_set_r5_from_r31_alt1=0x136EB4;// verify this
						g_set_r5_from_r31_alt2=0x045190;// verify this
						g_set_r6_from_r31=0x428DD4;
						g_set_r7_from_r31=0x428DCC;// verify this
				...
				case fwCompat[24]:
				   //alert(compat_msg_success);
					...
					if (confirm(msg_select_vsh_type)) {
						...
						g_1=0x0DEBD8;
						g_2=0x0976BC;
						g_set_r4_thru_r11=0x616B54;
						g_set_high_only=g_set_r4_thru_r11+0x7C;
						g_set_r0_from_r31=0x34D404;
						g_set_r3_from_r29=0x435530;
						g_set_r3_with_ld=0x1A43FC;
						g_set_r3_with_lwz_from_r31=0x37F0D0;
						g_set_r5_from_r29=0x054BA8;
						g_set_r5_from_r29_alt=0x4C7EF4;
						g_set_r5_from_r31=0x1BD764;// verify this
						g_set_r5_from_r31_alt1=0x136EB4;// verify this
						g_set_r5_from_r31_alt2=0x045190;
						g_set_r6_from_r31=0x428DD8;
						g_set_r7_from_r31=0x428DD0;// verify this
						//g_set_r31_E8=0x62ABD8;
						g_set_r12_110=0x029F8C;
						g_set_r31_F8=0x62F1E8;
						g_set_r31_108=0x6303B0;
						//g_set_r3_with_ld=0x7A00CC;
						//g_set_r3_and_clear=0x09F604;
						//g_set_r3_and_sc=0x208500;
						//g_set_r20_thru_r31=0x208538;
						...
						g_sc_A0=0x177684;// fixme
						g_sc_set_r3_from_r9=g_1-0x4;
						g_sc_set_r3_from_r10=0x32729C;
						g_sc_set_r3_with_lwz_from_r31=0x1BAC30;// alternate 0x3A4C28
						g_disc_load_cmp_stackframe=0xD010BC14;
						
						g_default_user_login_id=0x491578;
						g_printf=0x5A20A4;
						//g_printf2=0x536CF0;
						//g_printf3=0x1C23C8;
						//g_unk_lwmutex_lock=0x0ACF30;
						...
						g_init_shutdown=0x0C6730;
						//g_exit_chain=0x30FD38;
						g_exit_chain=0x2C24E0;
						
						// THESE BELOW OFFSETS NEED UPDATED FOR 4.82 STILL (USING 4.81 NOW)
				...
				case fwCompat[26]:
				   //alert(compat_msg_success);
					...
					if (confirm(msg_select_vsh_type)) {
						...
						//g_set_r31_E8=0x62ABD8;
						g_set_r12_110=0x029F8C;
						g_set_r31_F8=0x62F288;
						g_set_r31_108=0x630450;
						//g_set_r3_with_ld=0x7A00CC;
						//g_set_r3_and_clear=0x09F604;
						//g_set_r3_and_sc=0x208500;
						//g_set_r20_thru_r31=0x208538;
						...
						// THESE BELOW OFFSETS NEED UPDATED FOR 4.84 STILL (USING 4.81 NOW)
